...
const rawModules: Omit<LearningModule, "programTitle" | "skillTitle" | "enrolledCount">[] = [
  {
    id: "m-welcome",
...
export const modules: LearningModule[] = rawModules.map((m, i) => ({
  ...m,
  ...(MODULE_TAXONOMY[m.id] ?? { programTitle: "General", skillTitle: "Modules" }),
  enrolledCount: 60 + ((i * 47 + m.title.length * 13) % 220),
}));
...
export const leaderboard: LeaderboardEntry[] = [
  {
    ...
    userId: "u-8",
    name: "Rohit Menon",
    team: "Data Analytics and Engineering",
    modulesComplete: 14,
    points: 2840,
    isCurrentUser: false,
  },

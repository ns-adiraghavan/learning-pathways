              ...
              questions: [
                {
                  ...
                  prompt: "Which of these count as confidential client data? (select all)",
                  difficulty: "hard",
                  kind: "multi",
                  options: [
                    "Deliverable drafts",
                    "The client's raw datasets",
                    "A published press release",
                    "Access credentials",
                  ],
                  correctIndex: 0,
                  correctIndices: [0, 1, 3],
                  explanation: "Anything not already public is treated as confidential.",
                },
                {
                  id: `${summary.id}-a4-s2-q2`,
                  prompt: "The ISO refresher is an annual requirement.",
                  difficulty: "easy",
                  kind: "true_false",
                  options: ["True", "False"],
                  correctIndex: 0,
                  explanation: "The refresher must be completed every year.",
                },
              ],
            },
          ],
